...
namespace vslib
{
    ...
    class FullBridge : public Component
    {
      public:
        ...
        void setDutyCycle2L1Fsw(const float duty_cycle) noexcept
        {
            if (!m_bipolar)
            {
                switchBipolar(true);
        ...
        void setDutyCycle3L2Fsw(const float duty_cycle) noexcept
        {
        }
      ...
      private:
        ...
        bool m_bipolar;   //!< Flag informing whether the full bridge is running in bipolar mode
    };
}