...
TEST_F(LookupTableTest, LookupTableIntDefault)
{
    ...
    LookupTable<int32_t> table(name, nullptr);
...
{
    std::string         name = "table";
    LookupTable<double> table(name, nullptr);
    EXPECT_EQ(table.getName(), name);
...
{
    std::string      name = "table";
    LookupTable<int> table(name, nullptr);
...
{
    std::string              name = "table";
    LookupTable<double, int> table(name, nullptr);
...
{
    std::string                 name = "table";
    LookupTable<double, double> table(name, nullptr);
...
{
    std::string              name = "table";
    LookupTable<double, int> table_linear(name, nullptr);
    LookupTable<double, int> table_index(name, nullptr);

    std::vector<std::pair<double, int>> data_index{{-3, 3}, {-2, 2}, {-1, 1}, {0, 0}, {1, 1}, {2, 2}};
    std::vector<std::pair<double, int>> data_linear(data_index);
    table_linear.setData(std::move(data_index));
    table_index.setData(std::move(data_linear), true);
...
{
    std::string                 name = "table";
    LookupTable<double, double> table_linear(name, nullptr);
    LookupTable<double, double> table_index(name, nullptr);
