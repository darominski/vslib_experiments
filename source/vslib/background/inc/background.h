...
namespace vslib
{
    class BackgroundTask
    {
      public:
        ...
        //! queues
        BackgroundTask()
            : m_read_commands_queue{bmboot::createMessageQueue<bmboot::MessageQueueReader<SharedMemoryHeader>>(
                (uint8_t*)app_data_0_1_ADDRESS, fgc4::utils::constants::json_memory_pool_size
            )},
              m_write_parameter_map_queue{bmboot::createMessageQueue<bmboot::MessageQueueWriter<SharedMemoryHeader>>(
                  (uint8_t*)app_data_0_1_ADDRESS + fgc4::utils::constants::json_memory_pool_size,
      ...
      private:
        ...
        bmboot::MessageQueueReader<SharedMemoryHeader>                     m_read_commands_queue;
        bmboot::MessageQueueWriter<SharedMemoryHeader>                     m_write_parameter_map_queue;
