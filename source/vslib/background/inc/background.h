...
namespace vslib
{
    class BackgroundTask
    {
      public:
        ...
        //! queues
        BackgroundTask()
            : m_read_commands_queue{bmboot::createMessageQueue<bmboot::MessageQueueReader<SharedMemory>>(
                (uint8_t*)app_data_0_1_ADDRESS, fgc4::utils::constants::json_memory_pool_size
            )},
              m_write_parameter_map_queue{bmboot::createMessageQueue<bmboot::MessageQueueWriter<SharedMemory>>(
                  (uint8_t*)app_data_0_1_ADDRESS + fgc4::utils::constants::json_memory_pool_size,
      ...
      private:
        ...
        bmboot::MessageQueueReader<SharedMemory>                           m_read_commands_queue;
        bmboot::MessageQueueWriter<SharedMemory>                           m_write_parameter_map_queue;
