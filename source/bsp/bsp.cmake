function(MakeBsp EL)
    ...
    ExternalProject_Add(xil_bsp_el${EL}
            SOURCE_DIR ${BSP_HOME}
            CONFIGURE_COMMAND ""
            BUILD_COMMAND flock --exclusive bsp.lock make EL=el${EL} EXTRA_COMPILER_FLAGS=-I${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../bmboot/src/executor_domain/zynqmp/el${EL}
            INSTALL_COMMAND ""
    ...
    set_target_properties(fgc4_bsp_el${EL} PROPERTIES
            ...
            INTERFACE_INCLUDE_DIRECTORIES "${BSP_HOME}/psu_cortexa53_1/include;${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../bmboot/src/executor_domain/zynqmp/el${EL}"
            )

    set(BMBOOT_BSP_EL${EL}_HOME ${BSP_HOME}/psu_cortexa53_1 PARENT_SCOPE)
    set(BMBOOT_BSP_EL${EL}_INCLUDE_DIR ${BSP_HOME}/psu_cortexa53_1/include ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../bmboot/src/executor_domain/zynqmp/el${EL} PARENT_SCOPE)
