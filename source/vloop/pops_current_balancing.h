//! @file
//! @brief Defines the Component implementing new new approach to current balancing for POPS.
    ...
    class CurrentBalancing : public vslib::Component
    {
      public:
        ...
        balance(const double i_a, const double i_b, const double i_c, const double v_dc, const double common_modulation)
        {
            ...
            const double m_a = inv_r_a_scaled + common_modulation;
            const double m_b = inv_r_b_scaled + common_modulation;
            const double m_c = inv_r_c_scaled + common_modulation;
        ...
        vslib::Parameter<bool>
            fifth_filter_order;   //!< Whether to use fifth (true) or second (false) order moving average filter
        ...
        vslib::Parameter<std::array<double, 3>>
            a_factors;   //!< First column of the scaling matrix for balancing current
        vslib::Parameter<std::array<double, 3>>
            b_factors;   //!< Second column of the scaling matrix for balancing current
        vslib::Parameter<std::array<double, 3>>
            c_factors;   //!< Third column of the scaling matrix for balancing current
      ...
      private:
        std::array<double, 3>
            factors_a;   //!< Local copy of the first column of the scaling matrix for balancing current
        std::array<double, 3>
            factors_b;   //!< Local copy of the second column of the scaling matrix for balancing current
        std::array<double, 3>
            factors_c;   //!< Local copy of the third column of the scaling matrix for balancing current
    };
}