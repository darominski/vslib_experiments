...
namespace bmboot
{
    ...
    class IDomain
    {
      public:
        ...
        //!
        //! If the function returns with success, the domain state will be @link bmboot::monitor_ready
        //! monitor_ready@endlink.
        //!
        //! @return
        ...
        //!
        //! This operation is permissible only when the domain state is @link bmboot::monitor_ready
        //! monitor_ready@endlink.
